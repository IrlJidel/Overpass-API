...
#ifndef DE__OSM3S___LIBS__RSTARTREE__RSTARTREE_H
#define DE__OSM3S___LIBS__RSTARTREE__RSTARTREE_H
...
protected:
    ...
    // condense the tree after a deletion
...
public:
    ...
    // top k nearest neighbor function for both r-tree and r*-tree
